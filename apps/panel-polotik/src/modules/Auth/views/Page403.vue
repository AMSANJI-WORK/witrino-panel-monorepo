<template>
  <defualt-layout>
    <v-sheet class="ma-auto align-content-center">
      ...
      <v-row justify="center">
        <v-btn
          ...
          dark
          class="my-7 font-weight-bold mx-auto"
          @click="() => $router.back()"
          >بازگشت به صفحه قبلی</v-btn
        >
      </v-row>
    </v-sheet>
  </defualt-layout>
...
<script>
import Err403 from "@polotik/components/Icons/Err403.vue";
import Err403Moblie from "@polotik/components/Icons/ErrMoblie403.vue";
import DefualtLayout from "@polotik/modules/Auth/layout/Defualt.vue";
