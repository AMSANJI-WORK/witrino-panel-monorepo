...
export default {
  [GET_ALL_OFFER_BARTER_SUCCESS](state, payload) {
  ...
  [GET_ALL_OFFER_BARTER_FAILURE](_, error) {
    Vue.$toast.error("دریافت اطلاعات با خطا مواجه شد");
    console.log(error);
  },
  [GET_ONE_OFFER_BARTER_SUCCESS](state, payload) {
    state.offer = Object.assign({}, payload.data);
  },

  [GET_ONE_OFFER_BARTER_FAILURE](_, error) {
    Vue.$toast.error("دریافت اطلاعات با خطا مواجه شد");
    console.log(error);
  },
