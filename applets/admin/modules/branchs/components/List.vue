...
import LocationList from "@applets/admin/modules/branchs/components/LocationList.vue";
import DataTable from "@applets/admin/modules/branchs/components/DataTable/BranchList.vue";
import boxTopData from "@applets/admin/modules/branchs/mock/boxTop";
export default {
  components: {
    CardInfoDashboard,
    SectionDivider,
