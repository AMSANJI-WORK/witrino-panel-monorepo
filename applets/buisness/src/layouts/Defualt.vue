...
<script>
import AppHeader from "@applets/buisness/src/components/App/Header.vue";
...
import AppMobileSubHeader from "@applets/buisness/src/components/App/MobileSubHeader.vue";
import menuItems from "@applets/buisness/src/constants/menu";
import navigation from "@applets/buisness/src/constants/data";
...
export default {
  data() {
    return {
      ...
      navigation,
      DrawerCardTop: () =>
        import("@applets/buisness/src/components/App/DrawerCardTop.vue"),
    };
  },
  components: {
    AppHeader,
