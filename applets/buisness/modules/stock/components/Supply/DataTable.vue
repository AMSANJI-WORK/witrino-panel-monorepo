<template>
    ...
    >
        ...
        <template v-slot:[`item.actions`]="{ item }">
            ...
            <v-icon small color="yellow darken-1"> mdi-pencil </v-icon>
            <v-icon small color="blue darken-1"> mdi-checkbox-marked </v-icon>
        </template>
...
export default {
    data: () => ({
        ...
        headers: [
            ...
            { text: "زمان سفارش", value: "fat", class: HeaderDataTableClass },
            {
                text: "شماره تراکنش",
                value: "carbs",
                sortable: false,
