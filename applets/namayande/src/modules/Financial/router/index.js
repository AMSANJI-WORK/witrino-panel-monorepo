export default [
    {
        ...
        component: () => import("@namayande/modules/Financial/views/index.vue"),
        children: [
            {
                path: "totalReport/list",
                name: "financial-totalReport-list-page",
                component: () =>
                    import("@namayande/modules/Financial/views/TotalReport/List.vue"),
                childern: [
                    {
                        path: ":id/detail",
                        ...
                        component: () =>
                            import(
                                "@namayande/modules/Financial/views/TotalReport/Detail.vue"
                            ),
                        meta: {
                            breadCrumb: [
                                {
            ...
            },
            {
                ...
                component: () =>
                    import("@namayande/modules/Financial/views/Transaction/List.vue"),
                children: [
                    {
                        path: ":id/detail",
                        ...
                        component: () =>
                            import(
                                "@namayande/modules/Financial/views/Transaction/Detail.vue"
                            ),
                        meta: {
                            breadCrumb: [
                                {
