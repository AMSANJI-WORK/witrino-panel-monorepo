...
<script>
import boxTopData from "@applets/syndicate/src/modules/Messages/mock/boxTop";
import ProjectIcons from "@applets/syndicate/src/modules/Messages/components/ProjectIcons.vue";
import SectionDivider from "@commen/section-divider/components/SectionDivider.vue";
import DataTable from "@applets/syndicate/src/modules/Messages/components/Unread/DataTable.vue";
export default {
  components: {
    ProjectIcons,
    SectionDivider,
