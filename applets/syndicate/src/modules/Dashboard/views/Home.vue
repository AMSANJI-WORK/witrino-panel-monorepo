<template>
  <v-sheet class="transparent">
    ...
    <LocationList :lat="51.504" :long="-0.159" />
    <SectionDivider
    ...
    >
      <template #action>
        <v-btn color="grey darken-2" text x-small>مشاهده همه</v-btn>
      </template>
    </SectionDivider>
    <NotificationProduct />
  </v-sheet>
...
<script>
import boxTopData from "@applets/syndicate/src/modules/Dashboard/mock/boxTop";
...
import LocationList from "@applets/syndicate/src/modules/Dashboard/components/LocationList.vue";
export default {
  components: {
    CardInfoDashboard,
    SectionDivider,
