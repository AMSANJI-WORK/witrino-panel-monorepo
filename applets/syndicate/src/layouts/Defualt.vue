...
<script>
import AppHeader from "@applets/syndicate/src/components/App/Header.vue";
...
import AppMobileSubHeader from "@applets/syndicate/src/components/App/MobileSubHeader.vue";
import menuItems from "@applets/syndicate/src/constants/menu";
import navigation from "@applets/syndicate/src/constants/data";
...
export default {
  ...
  data() {
    return {
      ...
      navigation,
      DrawerCardTop: () =>
        import("@applets/syndicate/src/components/App/DrawerCardTop.vue"),
    };
  },
};
</script>
