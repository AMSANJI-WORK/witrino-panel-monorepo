<template>
  <v-card width="100%" elevation="0" rounded="lg" class="pt-2" height="100%">
    ...
    <div class="pa-2">
      ...
      >
        <v-list-item
          active-class="light-blue darken-4 white--text active-icon"
          v-if="!item.child"
          v-show="item.visible === true"
          :disabled="item.disabled"
          router
        ...
        >
          ...
          <v-list-item
            active-class="light-blue darken-4 white--text  boreder--bold active-icon"
