import { resetInquriry } from "@applets/polotik/inquiry/middlewares";
const inquiryRoutes = {
  path: "/inquiry",
  name: "inquiry-page",
  ...
  children: [
    {
      ...
      component: () => import("@applets/polotik/inquiry/views/List.vue"),
      meta: {
        breadCrumb: [
          {
            text: "لیست آگهی ها",
    ...
    },
    {
      ...
      component: () => import("@applets/polotik/inquiry/views/Preview.vue"),
    ...
    },
    {
      ...
      component: () => import("@applets/polotik/inquiry/views/Edit.vue"),
      beforeEnter: resetInquriry,
      meta: {
        breadCrumb: [
          {
    ...
    },
    {
      ...
      component: () => import("@applets/polotik/inquiry/views/Create.vue"),
      beforeEnter: resetInquriry,
      meta: {
        breadCrumb: [
          {
