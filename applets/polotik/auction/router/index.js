import { resetAuction } from "@applets/polotik/auction/middlewares";
const auctionRoutes = {
  path: "/auction",
  name: "auction-page",
  ...
  children: [
    ...
    },
    {
      ...
      component: () => import("@applets/polotik/auction/views/List.vue"),
      meta: {
        breadCrumb: [
          {
            text: "لیست آگهی ها",
    ...
    },
    {
      ...
      component: () => import("@applets/polotik/auction/views/Preview.vue"),
      beforeEnter: resetAuction,
      meta: {
        breadCrumb: [
          {
    ...
    },
    {
      ...
      component: () => import("@applets/polotik/auction/views/Edit.vue"),
      beforeEnter: resetAuction,
      meta: {
        breadCrumb: [
          {
    ...
    },
    {
      ...
      component: () => import("@applets/polotik/auction/views/Create.vue"),
      beforeEnter: resetAuction,
      meta: {
        breadCrumb: [
          {
