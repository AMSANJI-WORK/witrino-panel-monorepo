  ...
  >
    ...
    <template v-slot:[`item.actions`]="{ item }">
      ...
      <v-icon
        ...
        class="mx-2"
        @click="$router.push(`/operator/${item.calories}/edit`)"
      >
        mdi-pencil
      </v-icon>
      <!-- @click="$router.push(`/operator/${item.calories}/edit`)" -->
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "نام", value: "fat", class: HeaderDataTableClass },
      { text: "شهر", value: "carbs", class: HeaderDataTableClass },
      { text: "استان", value: "protein", class: HeaderDataTableClass },
      { text: "تاریخ شروع همکاری", value: "calories", class: HeaderDataTableClass },
