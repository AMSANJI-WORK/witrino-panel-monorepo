...
import { planTypes } from "@applets/witrino/admin/modules/plan/store/types";
import DisableDialog from "@applets/witrino/admin/modules/roles/components/DialogDisable.vue";
import loadingFormPlan from "@applets/witrino/admin/modules/plan/mixins/loading";
let service = "Plan";
export default {
  components: {
    DisableDialog,
