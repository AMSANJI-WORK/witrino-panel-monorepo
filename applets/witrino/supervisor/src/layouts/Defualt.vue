...
<script>
import AppHeader from "@applets/witrino/supervisor/src/components/App/Header.vue";
...
import AppMobileSubHeader from "@applets/witrino/supervisor/src/components/App/MobileSubHeader.vue";
import AppBreadcrumbs from "@applets/commen/breadcrumbs/components/Breadcrumbs.vue";
import menuItems from "@applets/witrino/supervisor/src/constants/menu";
import navigation from "@applets/witrino/supervisor/src/constants/data";
...
export default {
  ...
  data() {
    return {
      DrawerCardTop: () =>
        import("@applets/witrino/supervisor/src/components/App/DrawerCardTop.vue"),
      menuItems,
      navigation,
    };
  },
