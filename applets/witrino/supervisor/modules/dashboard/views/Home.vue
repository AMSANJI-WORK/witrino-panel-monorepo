...
<script>
import boxTopData from "@applets/witrino/supervisor/modules/dashboard/mock/boxTop";
...
import NotificationProduct from "@applets/commen/card/components/NotificationProduct.vue";
export default {
  components: {
    CardInfoDashboard,
    SectionDivider,
